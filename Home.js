...
const { FlatList, ScrollView, Text, TextInput, TouchableOpacity, View, StyleSheet } = require('react-native');
const foodData = require('../assets/raw_data/completedata.json');
const { Avatar } = require('@rneui/themed');
