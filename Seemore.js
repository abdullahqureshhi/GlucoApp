...
function Seemore({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.subContainerSpacing}>
        {/* Cuisine Type */}
        <Text style={[styles.recipeName, styles.fontWeightBold, styles.textColor, styles.mainTitleSize]}>
          {name}
        </Text>
        <Text style={[styles.cuisineType, styles.subTitleContentSize]}>
          Cuisine: {cuisine}
        </Text>
      </View>
      ...
      <View style={styles.subContainerSpacing}>
        {/* Ingredients */}
        <Text style={[styles.sectionTitle, styles.fontWeightBold, styles.textColor, styles.subTitleSize]}>
          Ingredients:
        </Text>
        <View style={{ gap: 5 }}>
          {ingredients.map((ingredient, index) => (
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }} key={index}>
              <Text style={[styles.ingredient, styles.textColor, styles.contentSize]}>
                {ingredient.name}:
              </Text>
              <Text style={[styles.ingredient, styles.textColor, styles.contentSize]}>
