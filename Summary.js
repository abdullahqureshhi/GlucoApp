...
const { FlatList, TextInput, TouchableOpacity, View, Text, StyleSheet, Modal } = require('react-native');
const { Icon } = require('@rneui/base');
const foodData = require('../assets/raw_data/completedata.json'); // Assuming the data is imported correctly

function Summary() {
    // Sorting food data by food_name
    ...
    // Function to toggle food item selection
    ...
    // Function to calculate totals (glycemic index and load)
    ...
    // Render modal for selecting food items
    const renderModal = () => (
...
// Export the component as a CommonJS module
